...
const FeatureCard = () => {
    ...
    return (
        <div className='container md:pt-14'>
            <div className="grid grid-cols-1 overflow-auto grid-rows-1 md:grid-cols-2 xl:grid-cols-4 justify-between px-1 md:px-5 md:gap-5 gap-2 mx-4 md:mx-0 py-2 md:py-6">
            ...
            <div className="lg:pl-20 py-12 max-w-full shadow-[0_0_0.25em_rgba(67,71,85,0.27),0_0.25em_1em_rgba(90,125,188,0.05)] rounded-lg">
                <div className="flex flex-col items-center lg:flex-row gap-5 max-md:flex-col max-md:gap-0 bg-[url('/images/mob_banner2.svg')] md:bg-[url('/images/banner2.png')] bg-cover lg:bg-auto bg-no-repeat bg-right py-5 lg:p-12 justify-between">
                    ...
                    <div className="flex flex-col items-center lg:items-end ml-5 mt-5 md:mt-0 mb-4 lg:mb-0">
                        <div className="flex overflow-hidden relative flex-col grow justify-center items-center md:items-end xl:text-3xl font-semibold text-white max-md:px-5">
                            <Link target='_blank' href={'https://www.niftytrader.in/primeplans'} className="text-white justify-center px-10 md:py-5 py-3 rounded-lg max-md:px-5 bg-gradient-to-r from-[#537E95] to-[#004063] cursor-pointer">
                                Get Free Trial
                            </Link>
                        </div>
                    </div>
